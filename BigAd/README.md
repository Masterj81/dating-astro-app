...
├── scripts/
│   └── test-logic.ts           `npm run test:logic` — 1257 checks
├── public/
├── next.config.ts
├── tailwind.config.ts
├── tsconfig.json
