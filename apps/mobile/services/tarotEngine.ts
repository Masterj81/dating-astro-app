/**
 * Tarot Engine — 78-card deck with seed-based deterministic draws.
 * Supports love and general reading modes.
 */
...
const MAJOR_ARCANA: Array<{
...
}> = [
  {
    ...
    love: {
      upright: 'A new romantic adventure awaits. Take a leap of faith in love — spontaneity brings magic.',
      reversed: 'Fear of commitment or recklessness in love. Slow down before jumping into something new.',
    },
    general: {
      upright: 'New beginnings and unlimited potential. Trust the journey even without a clear map.',
      reversed: 'Reckless decisions or fear of the unknown. Look before you leap.',
    },
  },
  {
    number: 1, name: 'The Magician',
    love: {
      upright: 'You have all the tools to manifest the love you desire. Confidence is magnetic.',
      reversed: 'Manipulation or illusion in love. Make sure intentions are genuine.',
    },
    general: {
      upright: 'Manifestation power is strong. You have everything you need to succeed.',
      reversed: 'Untapped potential or deception. Are you using your gifts wisely?',
    },
  },
  {
    number: 2, name: 'The High Priestess',
    love: {
      upright: 'Trust your intuition about a romantic interest. Hidden feelings may surface.',
      reversed: 'Ignoring your inner voice in love. Secrets or miscommunication.',
    },
    general: {
      upright: 'Deep intuition and inner wisdom. The answers are within — listen quietly.',
  ...
  },
  {
    ...
    love: {
      upright: 'Abundant love and nurturing energy. A deeply sensual and caring connection blossoms.',
      reversed: 'Codependency or neglecting self-care in relationships.',
    },
    general: {
      upright: 'Fertility, abundance, and creative flow. Nature and beauty surround you.',
      reversed: 'Creative blocks or lack of self-worth. Reconnect with what nourishes you.',
    },
  },
  {
    number: 4, name: 'The Emperor',
    love: {
      upright: 'Stability and structure in love. A partner who provides security and commitment.',
      reversed: 'Controlling or rigid behavior in relationships. Loosen the grip.',
    },
    general: {
      upright: 'Authority, discipline, and solid foundations. Lead with strength.',
      reversed: 'Tyranny, rigidity, or lack of discipline. Balance power with compassion.',
    },
  },
  {
    number: 5, name: 'The Hierophant',
    love: {
      upright: 'Traditional values in love — commitment, loyalty, and shared beliefs unite you.',
      reversed: 'Challenging conventions in love. An unconventional relationship path.',
    },
    general: {
      upright: 'Tradition, mentorship, and spiritual guidance. Seek wisdom from trusted sources.',
      reversed: 'Rebellion against structure. Question the rules that no longer serve you.',
    },
  },
  {
    number: 6, name: 'The Lovers',
    love: {
      upright: 'Deep soul connection and alignment. A significant romantic choice brings harmony.',
      reversed: 'Disharmony or difficult choices in love. Misaligned values.',
    },
    general: {
      upright: 'Important choices and partnerships. Alignment between heart and mind.',
      reversed: 'Inner conflict or poor choices. Avoid decisions made from fear.',
    },
  },
  {
    number: 7, name: 'The Chariot',
    love: {
      upright: 'Determination in love pays off. Pursue what your heart wants with confidence.',
      reversed: 'Forcing a relationship or losing direction in love.',
    },
    general: {
      upright: 'Willpower, victory, and forward momentum. Stay focused on your goal.',
  ...
  },
  {
    ...
    love: {
      upright: 'Gentle courage in love. Inner strength helps you navigate emotional challenges.',
      reversed: 'Self-doubt or emotional overwhelm in relationships.',
    },
    general: {
      upright: 'Courage, patience, and inner power. Tame challenges with compassion, not force.',
  ...
  },
  {
    ...
    love: {
      upright: 'Time for reflection on what you truly need in love. Solitude brings clarity.',
      reversed: 'Isolation or withdrawal from love. Don\'t shut people out.',
    },
    general: {
      upright: 'Soul-searching and inner guidance. Withdraw to find your truth.',
      reversed: 'Loneliness or excessive isolation. It\'s time to reconnect.',
    },
  },
  {
    number: 10, name: 'Wheel of Fortune',
    love: {
      upright: 'A turning point in your love life. Fate brings an unexpected romantic opportunity.',
      reversed: 'Resisting change in love. Bad luck in timing — patience is needed.',
    },
    general: {
      upright: 'Destiny, cycles, and turning points. Change is coming — embrace it.',
      reversed: 'Bad luck or resisting inevitable change. This too shall pass.',
    },
  },
  {
    number: 11, name: 'Justice',
    love: {
      upright: 'Fairness and balance in relationships. Honesty strengthens your bond.',
      reversed: 'Unfairness or dishonesty in love. Unresolved past actions catch up.',
    },
    general: {
      upright: 'Truth, fairness, and accountability. The right outcome will prevail.',
  ...
  },
  {
    ...
    love: {
      upright: 'Pause and see love from a new perspective. Surrender control for deeper connection.',
      reversed: 'Stalling in love or refusing to see things differently.',
    },
    general: {
      upright: 'Suspension, new perspectives, and letting go. Sometimes inaction is the answer.',
  ...
  },
  {
    ...
    love: {
      upright: 'Transformation in love — an ending that creates space for something better.',
      reversed: 'Resisting necessary change in a relationship. Holding on too tightly.',
    },
    general: {
      upright: 'Endings, transformation, and rebirth. Let go of what no longer serves you.',
      reversed: 'Resisting change, stagnation, or fear of transformation.',
    },
  },
  {
    number: 14, name: 'Temperance',
    love: {
      upright: 'Balance and patience in love. A harmonious relationship built on mutual respect.',
      reversed: 'Imbalance or excess in relationships. Find your center.',
    },
    general: {
      upright: 'Balance, moderation, and patience. Blend opposing forces with grace.',
  ...
  },
  {
    ...
    love: {
      upright: 'Intense attraction and passion, but beware of unhealthy attachments or obsession.',
      reversed: 'Breaking free from a toxic relationship pattern. Liberation.',
    },
    general: {
      upright: 'Shadow self, bondage, and temptation. What chains are you choosing to wear?',
  ...
  },
  {
    ...
    love: {
      upright: 'A sudden upheaval reveals the truth. Painful but necessary relationship revelation.',
      reversed: 'Avoiding an inevitable breakdown. The truth will come out.',
    },
    general: {
      upright: 'Sudden change, upheaval, and revelation. Destruction clears the way for truth.',
  ...
  },
  {
    ...
    love: {
      upright: 'Hope and healing in love. A beautiful, soul-nourishing connection is forming.',
      reversed: 'Losing faith in love. Don\'t give up — hope returns.',
    },
    general: {
      upright: 'Hope, inspiration, and renewal. After the storm, stars appear.',
      reversed: 'Hopelessness or disconnection from purpose. Faith will return.',
    },
  },
  {
    number: 18, name: 'The Moon',
    love: {
      upright: 'Hidden emotions and illusions in love. Trust your intuition, not appearances.',
      reversed: 'Clarity after confusion. Fears about love are dissolving.',
    },
    general: {
      upright: 'Illusion, fear, and the subconscious. Not everything is as it seems.',
  ...
  },
  {
    ...
    love: {
      upright: 'Joy, warmth, and radiant love. A relationship that makes you feel truly alive.',
      reversed: 'Temporary sadness or unrealistic expectations in love.',
    },
    general: {
      upright: 'Success, vitality, and joy. Everything is illuminated — enjoy this moment.',
      reversed: 'Temporary setbacks or dimmed optimism. The sun will shine again.',
    },
  },
  {
    number: 20, name: 'Judgement',
    love: {
      upright: 'A relationship awakening. Forgiveness and a higher calling in love.',
      reversed: 'Self-doubt or refusing to learn from past relationships.',
    },
    general: {
      upright: 'Awakening, renewal, and answering a higher calling.',
      reversed: 'Self-doubt, refusal to learn, or avoiding self-reflection.',
    },
  },
  {
    ...
    general: {
      upright: 'Completion, accomplishment, and wholeness. A major cycle reaches its peak.',
      reversed: 'Incompletion or shortcuts. Take the final step to finish what you started.',
    },
  },
];
...
const SUIT_MEANINGS: Record<string, { theme: string; loveTheme: string; names: string[] }> = {
  cups: {
...
export function getCardImageUrl(imageFile: string): string {
  return `${SUPABASE_URL}/storage/v1/object/public/${TAROT_BUCKET}/${imageFile}`;
}
...
export function generateReading(
  ...
  // Draw 3 cards (+ 1 advice for Cosmic)
  const positions: SpreadPosition[] = ['past', 'present', 'future', 'advice'];
  const cardCount = 4; // Always draw 4; UI decides whether to show advice

  const cards = positions.slice(0, cardCount).map((position, i) => {
    const baseCard = shuffled[i];
    const reversed = rng() < 0.3; // 30% chance reversed
...
export function getPositionLabel(position: SpreadPosition): {
  label: string;
  emoji: string;
} {
  switch (position) {
    case 'past':
      return { label: 'Past', emoji: '⏪' };
    case 'present':
      return { label: 'Present', emoji: '✨' };
    case 'future':
      return { label: 'Future', emoji: '🔮' };
    case 'advice':
      return { label: 'Cosmic Advice', emoji: '💫' };
  }
}
