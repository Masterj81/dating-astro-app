# AstroDating Instagram Carousel Storyboards

Complete storyboards with Midjourney prompts, captions, and text overlays for each slide.

---

## Carousel 1: How AstroDating Works

**Goal:** Explain the app to new users
**Slides:** 5
**Caption:**
```
...
#AstroDating #HowItWorks #AstrologyDating #BirthChart #ZodiacCompatibility #DatingApp #CosmicLove
```
...
## Carousel 2: Sun vs Moon vs Rising Explained

**Goal:** Educational content about astrology basics
**Slides:** 6
**Caption:**
```
Your Big 3 explained ☀️🌙⬆️

Most people only know their Sun sign. But your Moon and Rising are just as important for compatibility.

Swipe to learn what each one means for your love life 👉

Drop your Big 3 in the comments! Mine: Sagittarius ☀️ Scorpio 🌙 Libra ⬆️

#BigThree #SunMoonRising #AstrologyEducation #ZodiacSigns #NatalChart #AstrologyTok #LearnAstrology
```
...
## Carousel 3: Most Compatible Zodiac Matches

**Goal:** Engagement + showcase compatibility feature
**Slides:** 7
**Caption:**
```
The most compatible zodiac matches 💕

According to synastry (the astrology of relationships), these pairings have the highest compatibility scores.

Did your match make the list? 👀

Tag someone you're cosmically compatible with 👇

#ZodiacCompatibility #AstrologyMatches #Synastry #ZodiacLove #BestMatches #AstrologyCouples #CosmicConnection
```
...
## Carousel 4: Red Flags by Zodiac Sign

**Goal:** Entertainment/humor for engagement
**Slides:** 7 (covering all signs in groups)
**Caption:**
```
Red flags by zodiac sign 🚩

We love all signs... but let's be honest about our toxic traits 😅

Which one called you out? Be honest in the comments 👇

Save this for reference on your next date 📌

#ZodiacRedFlags #AstrologyMemes #ZodiacHumor #ToxicTraits #AstrologyTok #ZodiacSigns #Relatable
```
...
**Text Overlay:**
"🌿 Earth Signs"
"♉ Taurus: Stubborn to the grave"
"♍ Virgo: Criticizes everything"
...
**Text Overlay:**
"💨 Air Signs"
"♊ Gemini: Has 3 different personalities"
"♎ Libra: Can't make a decision"
...
**Text Overlay:**
"🌊 Water Signs"
"♋ Cancer: Brings up things from 2017"
"♏ Scorpio: Knows your secrets already"
...
## Carousel 5: Venus Signs - How You Love

**Goal:** Educational deep-dive content
**Slides:** 6
**Caption:**
```
Your Venus sign reveals HOW you love 💕

Most people know their Sun sign, but Venus is the planet of love and attraction.

Where was Venus when you were born? That's your love language written in the stars ✨

Comment your Venus sign below! Don't know it? Our app calculates it for you 👀

#VenusSign #LoveLanguage #AstrologyLove #HowYouLove #ZodiacVenus #RelationshipAstrology #AstroDating
```
...
**Text Overlay:**
"Venus in Fire Signs 🔥"
"Aries Venus: Loves the chase"
"Leo Venus: Grand romantic gestures"
...
"Taurus Venus: Physical touch + gifts"
"Virgo Venus: Acts of service"
...
**Text Overlay:**
"Venus in Air Signs 💨"
"Gemini Venus: Words of affirmation"
"Libra Venus: Partnership is everything"
...
"Cancer Venus: Nurtures deeply"
"Scorpio Venus: All or nothing"
...
## Carousel 6: What Each Sign Wants in a Partner

**Goal:** High engagement + saves
**Slides:** 5 (grouped by element)
**Caption:**
```
What each sign ACTUALLY wants in a partner 💕

Be honest... did we get yours right? 👀

Save this for reference and tag someone who fits what you're looking for 👇

#ZodiacPartner #WhatYouWant #IdealMatch #ZodiacLove #AstrologyDating #RelationshipGoals #SignsInLove
```
...
**Text Overlay:**
"🔥 Fire Signs Want:"
"♈ Aries: Someone who keeps up"
"♌ Leo: Someone who adores them"
...
**Text Overlay:**
"🌿 Earth Signs Want:"
"♉ Taurus: Loyalty and comfort"
"♍ Virgo: Someone with their life together"
...
1. Copy each Midjourney prompt
2. Paste in Midjourney Discord: `/imagine prompt: [paste here]`
3. Wait for generation
4. Pick best variation (V1-V4)
5. Upscale (U1-U4)
6. Download image

### Step 2: Add Text in Canva
1. Go to canva.com
2. Create design → Instagram Post (1080 x 1350 px)
3. Upload Midjourney image as background
4. Add text overlays from storyboard
5. Use fonts:
   - Headlines: Playfair Display or Bodoni
   - Body: Inter or Montserrat
6. Colors: White text with subtle drop shadow

### Step 3: Export
1. Download all slides as PNG
2. Name files: carousel-name-01.png, carousel-name-02.png, etc.
3. Upload to Instagram in order

### Step 4: Post
1. Select all slides in order
2. Add caption from storyboard
3. Add hashtags (first comment or end of caption)
4. Post at optimal time (11AM-1PM or 7PM-9PM)
...
### Consistency
- Use same background gradient across all slides
- Keep text in same position on each slide
- Use consistent icon style

### Engagement Hooks
- Slide 1 should create curiosity
- Last slide always has CTA
- Middle slides deliver value

### Saving/Sharing
- Educational content gets saved
- Controversial content gets shared
- Relatable content gets comments

### Text Readability
- Maximum 20-30 words per slide
- High contrast (white on dark)
- Large font size (minimum 24px)
